...
class Poduser(models.Model):
    ...
    profile_picture = models.ImageField(blank=True, null=True, default='alisahmoud.jpg')
...
class Podcast(models.Model):
    ...
    podcast_image = models.ImageField(blank=True, null=True, default='url("alisahmoud.jpg")')
...
class Episode(models.Model):
    ...
    episode_image = models.ImageField(blank=True, null=True, default='alisahmoud.jpg')
