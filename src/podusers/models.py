...
class Poduser(models.Model):
    ...
    profile_picture = models.ImageField(blank=True, null=True, default='profilepicture.jpeg')
...
class Episode(models.Model):
    ...
    episode_image = models.ImageField(blank=True, null=True, default='Mic.png')
